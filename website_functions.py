...
def load_data():
    unicorn_df= pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/INFO_UNICORN_FINAL.xlsx')
    vcs= pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/INFO_INVESTORS.xlsx')
    capital= pd.read_csv('/Users/fab/Desktop/UNICORN_ANALYSIS/mine/country-capital-lat-long-population.csv')
    countries_df = pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/Startup_per_country.xlsx', skiprows=3)
    unicorn_df2= pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/INFO_UNICORN_FINAL.xlsx')
    vcs2= pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/INFO_INVESTORS.xlsx')
    capital2= pd.read_csv('/Users/fab/Desktop/UNICORN_ANALYSIS/mine/country-capital-lat-long-population.csv')
    countries_df2 = pd.read_excel('/Users/fab/Desktop/UNICORN_ANALYSIS/Startup_per_country.xlsx', skiprows=3)
...
def main():
    ...
    page = st.sidebar.selectbox("Choose a topic", ["Home Page", "The Market Evolution", "Investments","Investments Flow" ,"Backgrounds", "The Evolution of Womens' Roles"])
    ...
    elif page == "Focus on Women roles":
        st.markdown("""
        <style>
            /* Adjusts the padding and maximum width of the main container */
            .appview-container .main .block-container {
